      ...
      <Row className="w-100 mx-auto">
                ...
                <div
                  ...
                  className={
                    i === current
                      ...
                      : "d-flex d-lg-block mb-4 justify-content-center align-items-center p-2 cursor"
                  }
        ...
        <Col md={6} lg={4}>
          <div className="border border-danger p-3">
            ...
            <p>{formatCurrency(productId.price)}</p>
            <Button variant="danger" className="w-100 rounded-0 mb-4" size="lg"
